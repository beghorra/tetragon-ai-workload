...
#
# Shared verification helpers for the "Protecting AI Workloads and AI Agents
# with Tetragon and Splunk" AI agent + MCP demo. This is
...
status_board() {
  ui_banner "Protecting AI Workloads and AI Agents with Tetragon and Splunk" "status board  ($(date -u +%FT%TZ))"
  show_workload
  show_policies
  show_context
